...
* Exhaustive Verification of Web Forms: You will focus on testing all types of forms, verifying fields, data validations (error messages, data types, etc.), user flows, and the correct integration of submitted information.
* Manual Test Execution: You will be responsible for executing test cases (functional, regression, and usability) to ensure that new developments meet requirements, with a special focus on user interaction.
* Incident Identification and Reporting: You will clearly and thoroughly document errors or bugs found in tracking tools (such as JIRA), collaborating on their follow-up until resolution.
* Active Learning and Collaboration: You will work closely with development and product teams, learning about the software development lifecycle in an agile environment and participating in team ceremonies
* Compatibility Testing: You will help verify that our forms and applications work correctly and maintain visual consistency (UI/UX) across different browsers and devices