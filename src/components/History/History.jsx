...
const History = () => {
  return (
    <div className="u-bg-jobs-bastille">
        ...
        <div className="Section-content">
          <div className="row">
            <div className="offset-md-3 col-md-6">
              ...
              <p className="Typography Typography--body3 Typography--white Typography--centered Typography--thin">
      ...
      <section className="Section  u-noPaddedTop">
        <div className="Section-content">
          <div className="row">
            <div className="offset-md-2 col-md-8">
              <div className="ContentGroup-title">
                <h2 className="Typography Typography--heading2 Typography--centered Typography--white">
                Join the Team of Top IT Talents!
                </h2>
              </div>
            </div>
          </div>
